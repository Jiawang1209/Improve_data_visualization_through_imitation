...
class AppConfig:
    ...
    # 应用默认标签页标题
    title = 'Improve data visualization through imitation (IDVTI)'

    # 应用logo地址
    logo_path = 'imgs/profile_photo.jpg'
    ...
    # 组件仓库地址
    library_repo = 'https://github.com/Jiawang1209/Improve_data_visualization_through_imitation'

    # 文档仓库地址
    doc_library_repo = 'https://github.com/Jiawang1209/Improve_data_visualization_through_imitation'

    # 文档Gitee仓库地址
    doc_gitee_library_repo = 'https://github.com/Jiawang1209/Improve_data_visualization_through_imitation'
    ...
    # 项目国际化指南地址
    i18n_guide_link = (
        'https://github.com/Jiawang1209/Improve_data_visualization_through_imitation'
    )
    @staticmethod
